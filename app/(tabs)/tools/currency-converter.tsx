...
const CURRENCIES = [
  ...
  'KRW', 'MXN', 'SGD', 'HKD', 'NOK', 'SEK', 'DKK', 'NZD', 'ZAR', 'TRY', 'BDT'
];
      ...
      >
        <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
          ...
          <LinearGradient colors={theme.palette.gradient as any} style={styles.featuredCard}>
            <Text style={styles.featuredLabel}>CURRENCY CONVERSION</Text>
            ...
            <View style={styles.featuredBadge}>
              ...
              <Text style={[styles.featuredBadgeText, { color: theme.colors.accent }]}>
                {numAmount.toLocaleString()} {from} = {loading ? '...' : result} {to}
              </Text>
            </View>
          </LinearGradient>
