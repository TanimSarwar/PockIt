    ...
    <View style={[s.root, { backgroundColor: theme.colors.background }]}>
      ...
      <View style={s.pageHead}>
        <View style={s.titleRow}>
          ...
          <Text style={[s.pageTitle, { color: theme.colors.text }]}>QR Generator</Text>
        </View>
        <Text style={[s.pageSub, { color: theme.colors.textSecondary }]}>Create instant QR codes for links or text.</Text>
      </View>
