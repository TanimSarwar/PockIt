...
export const features: Feature[] = [
  ...
  { id: 'barcode-scanner', name: 'Barcode Scanner', icon: 'barcode-scan', route: '/(tabs)/tools/barcode-scanner', category: 'tools', description: 'Scan barcodes and QR codes', layout: 'wide' },
  { id: 'password-generator', name: 'Password Gen', icon: 'lock-outline', route: '/(tabs)/tools/password-generator', category: 'tools', description: 'Generate strong random passwords', layout: 'wide' },
  ...
  { id: 'qr-generator', name: 'QR Generator', icon: 'qrcode', route: '/(tabs)/tools/qr-generator', category: 'tools', description: 'Generate QR codes from text or URLs', layout: 'wide' },
  ...
  { id: 'stocks', name: 'Stock Prices', icon: 'chart-line', route: '/(tabs)/finance/stocks', category: 'finance', description: 'Track stock prices and changes', layout: 'wide' },
  ...
  // ─── Utilities ────────────────────────────────────────────────────────────
  { id: 'habit-tracker', name: 'Habit Tracker', icon: 'chart-timeline-variant-shimmer', route: '/(tabs)/utilities/habit-tracker', category: 'utilities', description: 'Build streaks and track habits', layout: 'wide' },
  { id: 'todo-list', name: 'To-Do List', icon: 'checkbox-marked-outline', route: '/(tabs)/utilities/todo-list', category: 'utilities', description: 'Tasks with priorities and due dates', layout: 'wide' },
  ...
  { id: 'notes', name: 'Quick Notes', icon: 'note-text-outline', route: '/(tabs)/utilities/notes', category: 'utilities', description: 'Jot down thoughts quickly', layout: 'wide' },
  ...
  { id: 'country-info', name: 'Country Info', icon: 'flag-outline', route: '/(tabs)/utilities/country-info', category: 'utilities', description: 'Country flags, capitals & facts', layout: 'wide' },
  { id: 'timezone-converter', name: 'Time Zones', icon: 'clock-outline', route: '/(tabs)/utilities/timezone-converter', category: 'utilities', description: 'Convert between time zones', layout: 'wide' },
